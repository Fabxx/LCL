...
bool retro_load_game(const struct retro_game_info *info)
{
      ...
      snprintf(path, sizeof(path), "%s/.config/retroarch/thumbnails/Nintendo - DS", home);
      ...
      snprintf(path, sizeof(path), "%s/.config/retroarch/thumbnails/Nintendo - DS/Named_Boxarts", home);
      ...
      snprintf(path, sizeof(path), "%s/.config/retroarch/thumbnails/Nintendo - DS/Named_Snaps", home);
      ...
      snprintf(path, sizeof(path), "%s/.config/retroarch/thumbnails/Nintendo - DS/Named_Titles", home);
      ...
      snprintf(path, sizeof(path), "%s/.config/retroarch/system/melonDS", home);
      ...
      snprintf(emuList, sizeof(emuList), "%s/.config/retroarch/system/melonDS/melonDS-x86_64.AppImage", home);
    ...
    "bash -c 'json_data=$(curl -s -H \"Accept: application/json\" \"https://api.github.com/repos/melonDS-emu/melonDS/releases/latest\"); "
         ...
         if (system(download) != 0) {
            ...
            snprintf(extraction, sizeof(extraction), "unzip %s/melonDS.zip -d %s && rm %s/melonDS.zip", path, path, path);
            ...
            if (system(extraction) != 0) {
               ...
               char chmod[512] = {0};
               snprintf(chmod, sizeof(chmod), "chmod +x %s/melonDS-x86_64.AppImage", path);
