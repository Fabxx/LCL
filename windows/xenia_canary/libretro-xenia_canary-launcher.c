...
bool retro_load_game(const struct retro_game_info *info)
{
    ...
    "powershell -Command \"$tag = Invoke-WebRequest -Uri 'https://api.github.com/repos/xenia-canary/xenia-canary-releases/releases' -Headers @{Accept='application/json'}; "
            "$tag = $tag.Content | ConvertFrom-Json | Select-Object -First 1 -ExpandProperty tag_name; "
