...
bool retro_load_game(const struct retro_game_info *info)
{
      ...
      snprintf(path, sizeof(path), "%s/Library/Application Support/RetroArch/thumbnails/Sony - Playstation", home);
      ...
      snprintf(path, sizeof(path), "%s/Library/Application Support/RetroArch/thumbnails/Sony - Playstation/Named_Boxarts", home);
      ...
      snprintf(path, sizeof(path), "%s/Library/Application Support/RetroArch/thumbnails/Sony - Playstation/Named_Snaps", home);
      ...
      snprintf(path, sizeof(path), "%s/Library/Application Support/RetroArch/thumbnails/Sony - Playstation/Named_Titles", home);
      ...
      snprintf(path, sizeof(path), "%s/Library/Application Support/RetroArch/system/duckstation", home);
      ...
      snprintf(emuList, sizeof(emuList), "%s/Library/Application Support/RetroArch/system/DuckStation.app/Contents/MacOS/DuckStation", home);
    ...
    "bash -c 'json_data=$(curl -s -H \"Accept: application/json\" \"https://api.github.com/repos/stenzek/duckstation/releases/latest\"); "
         ...
         char download[256] = {0};
         snprintf(download, sizeof(download), "wget -O %s/duckstation.zip %s", path, url);
         ...
         if (system(download) != 0) {
            ...
            return false;
               ...
               char chmod[512] = {0};
               snprintf(chmod, sizeof(chmod), "chmod +x %s/DuckStation.app/Contents/MacOS/DuckStation", path);
