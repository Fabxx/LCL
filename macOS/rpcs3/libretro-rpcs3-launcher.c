 ...
 * NOTE: Rename RPCS3.app folder in rpcs3.app
 * NOTE: Obtaining portable 7z for extraction.
 */
static bool extractor(char **Paths)
{
   ...
   snprintf(getSZip, sizeof(getSZip), "wget -O %s/7z.tar.xz %s", Paths[0], url);
