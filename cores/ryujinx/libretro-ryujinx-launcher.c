...
void retro_get_system_info(struct retro_system_info *info)
{
   ...
   info->library_name     = "Ryujinx Launcher";
   info->library_version  = "0.1a";
   info->need_fullpath    = true;
   info->valid_extensions = "nsp|xci";
}
...
static bool downloader(char **Paths, char **downloaderDirs, char **githubUrls)
{
  ...
  "bash -c 'json_data=$(curl -s -H \"Accept: application/json\" \"%s\"); "
   ...
   #ifdef __linux__
   snprintf(command, sizeof(command), 
   "wget -O %s/Ryujinx.AppImage %s && chmod +x %s", Paths[0], url, Paths[6]);
   
   #elif defined __APPLE__
   snprintf(command, sizeof(command), "wget -O %s/Ryujinx.tar.gz %s", Paths[0], url);
   
   #elif defined __WIN32__
      snprintf(command, sizeof(command),"powershell -Command \"Invoke-WebRequest -Uri '%s' -OutFile '%s\\Ryujinx.zip'\"", url, Paths[0]);
      ...
      if (system(command) != 0) {
         ...
         if (!urlFile || !currentVersionFile || !newVersionFile) {
            ...
            if (strcmp(currentVersion, newVersion) != 0) {
               ...
               snprintf(command, sizeof(command), 
                       "wget -O %s/Ryujinx.tar.gz %s", Paths[0], url);
               
               #elif defined __WIN32__
               
                snprintf(command, sizeof(command),
                       "powershell -Command \"Invoke-WebRequest -Uri '%s' -OutFile '%s\\Ryujinx.zip'\"", url, Paths[0]);
               #endif
...
bool retro_load_game(const struct retro_game_info *info)
{
   ...
   char *dirs[] = {
         "/.config/retroarch/system/Ryujinx",
         "/.config/retroarch/system/Ryujinx/bios",
         "/.config/retroarch/thumbnails/Nintendo - Switch",
         "/.config/retroarch/thumbnails/Nintendo - Switch/Named_Boxarts",
         "/.config/retroarch/thumbnails/Nintendo - Switch/Named_Snaps",
         "/.config/retroarch/thumbnails/Nintendo - Switch/Named_Titles",
         "/.config/retroarch/system/Ryujinx/Ryujinx.AppImage" // search Path for glob.
      };
   
   // Emulator build versions and URL to download. Content is generated from powershell cmds
   char *downloaderDirs[] = {
      "/.config/retroarch/system/Ryujinx/0.Url.txt",
      "/.config/retroarch/system/Ryujinx/1.CurrentVersion.txt",
      "/.config/retroarch/system/Ryujinx/2.NewVersion.txt",
   };
   ...
   char *dirs[] = {
         "/Library/Application Support/RetroArch/system/Ryujinx",
         "/Library/Application Support/RetroArch/system/Ryujinx/bios",
         "/Library/Application Support/RetroArch/thumbnails/Nintendo - Switch",
         "/Library/Application Support/RetroArch/thumbnails/Nintendo - Switch/Named_Boxarts",
         "/Library/Application Support/RetroArch/thumbnails/Nintendo - Switch/Named_Snaps",
         "/Library/Application Support/RetroArch/thumbnails/Nintendo - Switch/Named_Titles",
         "/Library/Application Support/RetroArch/system/Ryujinx/Ryujinx.app/Contents/MacOS/Ryujinx" // search Path for glob.
      };

   // Emulator build versions and URL to download. Content is generated from powershell cmds
   char *downloaderDirs[] = {
      "/Library/Application Support/RetroArch/system/Ryujinx/0.Url.txt",
      "/Library/Application Support/RetroArch/system/Ryujinx/1.CurrentVersion.txt",
      "/Library/Application Support/RetroArch/system/Ryujinx/2.NewVersion.txt",
   };
   ...
   char *dirs[] = {
         "C:\\RetroArch-Win64\\system\\Ryujinx",
         "C:\\RetroArch-Win64\\system\\Ryujinx\\bios",
         "C:\\RetroArch-Win64\\thumbnails\\Nintendo - Switch",
         "C:\\RetroArch-Win64\\thumbnails\\Nintendo - Switch\\Named_Boxarts",
         "C:\\RetroArch-Win64\\thumbnails\\Nintendo - Switch\\Named_Snaps",
         "C:\\RetroArch-Win64\\thumbnails\\Nintendo - Switch\\Named_Titles"
      };
   
   char *downloaderDirs[] = {
      "C:\\RetroArch-Win64\\system\\Ryujinx\\0.Url.txt",
      "C:\\RetroArch-Win64\\system\\Ryujinx\\1.CurrentVersion.txt",
      "C:\\RetroArch-Win64\\system\\Ryujinx\\2.NewVersion.txt",
   };
   ...
   char *githubUrls[] = {
      ...
      "https://github.com/Ryubing/Ryujinx/releases/download/"
   };
   ...
   if (strlen(executable) > 0) {
      ...
      if (system(executable) == 0) {
         log_cb(RETRO_LOG_INFO, "[LAUNCHER-INFO]: Finished running Ryujinx.\n");
         return true;
      } else {
         log_cb(RETRO_LOG_ERROR, "[LAUNCHER-ERROR]: Failed running Ryujinx.\n");
      }
   }
   return false;
}
