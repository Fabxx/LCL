...
bool retro_load_game(const struct retro_game_info *info)
{
      ...
      const char *thumbDirs[] = {"\\Sony - Playstation", "\\Named_Boxarts", "\\Named_Snaps", "\\Named_Titles"};
      const char *url = "https://github.com/stenzek/duckstation/releases/download/preview/duckstation-windows-x64-release.zip";
