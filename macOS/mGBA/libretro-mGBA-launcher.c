...
bool retro_load_game(const struct retro_game_info *info)
{
      ...
      snprintf(path, sizeof(path), "%s/Library/Application Support/RetroArch/thumbnails/Nintendo - Game Boy Advance", home);
      ...
      snprintf(path, sizeof(path), "%s/Library/Application Support/RetroArch/thumbnails/Nintendo - Game Boy Advance/Named_Boxarts", home);
      ...
      snprintf(path, sizeof(path), "%s/Library/Application Support/RetroArch/thumbnails/Nintendo - Game Boy Advance/Named_Snaps", home);
      ...
      snprintf(path, sizeof(path), "%s/Library/Application Support/RetroArch/thumbnails/Nintendo - Game Boy Advance/Named_Titles", home);
      ...
      snprintf(path, sizeof(path), "%s/Library/Application Support/RetroArch/system/mGBA", home);
      ...
      snprintf(emuList, sizeof(emuList), "%s/Library/Application Support/RetroArch/system/mGBA/mGBA.app/Contents/MacOS/mGBA", home);
