...
bool retro_load_game(const struct retro_game_info *info)
{
      ...
      snprintf(path, sizeof(path), "%s/Library/Application Support/RetroArch/thumbnails/Nintendo - 3DS", home);
      ...
      snprintf(path, sizeof(path), "%s/Library/Application Support/RetroArch/thumbnails/Nintendo - 3DS/Named_Boxarts", home);
      ...
      snprintf(path, sizeof(path), "%s/Library/Application Support/RetroArch/thumbnails/Nintendo - 3DS/Named_Snaps", home);
      ...
      snprintf(path, sizeof(path), "%s/Library/Application Support/RetroArch/thumbnails/Nintendo - 3DS/Named_Titles", home);
      ...
      snprintf(path, sizeof(path), "%s/Library/Application Support/RetroArch/system/lime3ds", home);
      ...
      snprintf(emuList, sizeof(emuList), "%s/Library/Application Support/RetroArch/system/lime3ds/lime3ds*/lime3ds.app/Contents/MacOS/lime3ds", home);
    ...
    "bash -c 'json_data=$(curl -s -H \"Accept: application/json\" \"https://api.github.com/repos/Lime3DS/lime3ds-archive/releases/latest\"); "
         ...
         char download[512] = {0};
         snprintf(download, sizeof(download), "wget -O %s/lime3ds.zip %s", path, url);
         ...
         if (system(download) != 0) {
            ...
            snprintf(extraction, sizeof(extraction), "unzip %s/lime3ds.zip -d %s && rm %s/lime3ds.zip", path, path, path);
            ...
            if (system(extraction) != 0) {
               ...
               char chmod[512] = {0};
               snprintf(chmod, sizeof(chmod), "chmod +x %s/lime3ds*/lime3ds.app/Contents/MacOS/lime3ds", path);
